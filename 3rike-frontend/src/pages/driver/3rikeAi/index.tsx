...
import { ArrowUpRight} from "lucide-react"; // Icons
...
export default function AiDashboard() {
    ...
    async function onSubmit(data: z.infer<typeof formSchema>) {
        ...
        // navigate("/driver"); // Uncomment if navigation is needed on submit
    };
        ...
        <div className="min-h-screen bg-white flex justify-center">
            ...
            <div className="w-full max-w-100 bg-white shadow-2xl overflow-hidden min-h-200 relative pb-10 pt-4">
                ...
                <div className="px-5 space-y-4">
                    ...
                    {/* Fixed at bottom, full width, with padding to prevent overflow */}
                                        ...
                                        <FormItem>
                                            <FormControl>
                                                <div className="relative">
                                                    ...
                                                    >
                                                        {hasText ? (
                                                            // Icon when text is entered (Square/Stop)
                                                            <div className="w-4 h-4 bg-white rounded-[2px]" />
                                                        ) : (
                                                            // Icon when empty (Arrow)
